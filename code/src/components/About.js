...
utbildningar inom ledarskap, kommunikation och pedagogik.</TextCard>
          <Logos> <Logo src={RYT}></Logo>
            <Logo src={yogayama}></Logo></Logos>



          <Subheading>Min väg till yogan</Subheading>   <TextCard>       Allt eftersom livet brusat på har min längtan efter inre frid blivit
          ...
          <br /> <br />Genom detta har jag lärt känna yogan, dess syften och effekter,
        ...
        mer harmoniskt och balanserat liv.</TextCard>
